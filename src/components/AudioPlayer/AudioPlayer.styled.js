...
export const PlayerBtnShaffle = styled(PlayerBtn)`
  &:hover svg {
    fill: transparent;
    stroke: #acacac;
    cursor: pointer;
...
export const TrackPlayAutor = styled.div`
  -ms-grid-row: 1;
  -ms-grid-column: 2;
  grid-area: author;
  min-width: 49px;
...
export const TrackPlayAutorLink = styled.a`
  font-style: normal;
  font-weight: 400;
  font-size: 16px;
  line-height: 24px;
...
export const VolumeImage = styled.div`
  ...
  margin-right: 17px;
`
export const PVolumeSvg = styled.svg`
  width: 13px;
  height: 18px;
  fill: transparent;
`
